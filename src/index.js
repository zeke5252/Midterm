    ...
    render() {
        ...
        return (
            <div>
                ...
                <Switch>
                    <Route path='/' component={() => <StartSec title={this.state.headline} />} exact />
                    <Route path={'/'+ this.state.tempRoutes.reactRoute} component={ReactSec} />
                    <Route path={'/'+ this.state.tempRoutes.reduxRoute} component={ReduxSec} />
